...
The recognizable solutions which solve common design problems. This is a library which can be used in conjunction with any design. It is not the rendered styles for your particular site. [For more information](http://boagworld.com/design/pattern-library/).
...
- [More information](http://alistapart.com/article/style-tiles-and-how-they-work)
- [Examples](http://foodbank.bradfrostweb.com/design/03062014/styletiles.html)
...
- [Sample prototypes](http://drupalizeme.github.io/prototypes/)
...
- [Comparison of OOCSS frameworks](http://clubmate.fi/oocss-acss-bem-smacss-what-are-they-what-should-i-use/)
...
- [Comparison of CSS preprocessors](http://code.tutsplus.com/tutorials/sass-vs-less-vs-stylus-preprocessor-shootout--net-24320)
...
A [front end style guide](http://24ways.org/2011/front-end-style-guides/) is ideal. It gives examples of what the rendered CSS should look like in a browser. These are generally compiled at the end of the design phase; however, front end developers should consider having an in-code style guide as well (or instead of) this type of style guide.
